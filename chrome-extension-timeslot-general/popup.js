...
// 履歴データURL
const HISTORY_URL = 'https://storage.googleapis.com/fujimino-reservation-status/history-general';
...
async function fetchTodayHistory() {
  try {
    ...
    console.log('[一般予約枠数] 履歴データ取得失敗:', e);
    return null;
  }
}
...
function analyzeSlotFillTimes(historyData) {
  ...
  console.log('[一般予約枠数] 埋まり時刻:', slotFillTimes);
  console.log('[一般予約枠数] 空き時刻:', slotOpenTimes);
}

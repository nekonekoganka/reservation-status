...
5. **全画面ディスプレイ** - レスポンシブ対応・アイコン表示（😊/😔）・バナー表示 🆕
6. **デバッグページ** - テキスト・アイコン・色・アニメーションを自由にカスタマイズ 🆕
...
- **🎨 デザインタブ**: アイコン選択・カラーピッカー（背景色・文字色）
- **⚡ アニメタブ**: アニメーション制御・フォントサイズ調整

**主な機能**
- リアルタイムプレビュー（変更が即座に反映）
- アイコン選択（😊✅✔️⭕🟢👍 / 😔❌✖️🙇⛔🚫 + カスタム入力）
- パルスアニメーション ON/OFF・速度・拡大率調整
- フェードインアニメーション ON/OFF
- フォントサイズスライダー（クリニック名・アイコン・メインメッセージ）
- すべてリセット機能
